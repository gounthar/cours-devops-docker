...
**Problème** : `localhost:12201` pointe vers le **conteneur backend**, pas vers logstash !
...
services:
  webapp:
    ...
    logging:
      driver: gelf
      options:
        gelf-address: "udp://localhost:12201"          # ❌ Erreur 3
...
* ❌ `localhost:12201` pour GELF logging → **Utiliser** `logstash:12201`
