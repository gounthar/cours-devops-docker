...
Montrer docker container exec <container> whoami → retourne "root" = MAUVAIS !
--
...
* Vérifier : `docker container exec <container> whoami`
...
[%step]
Vérifier : `docker container exec <container> id appuser`
