...
image::3_typesègestions_données.png[height=600]
...
docker container run --rm \
  ...
  busybox cp -r /chemin/vers/la/page/web/sur/lhote .   # Copiez récursivement le contenu depuis "/chemin/vers/la/page/web/sur/lhote" dans le répertoire actuel du conteneur.
----
[%step]
