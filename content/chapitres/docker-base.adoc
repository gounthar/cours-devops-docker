...
image::blue-shipping-container.png[background, size=contain, position=left]
...
== 🧭 Deux écritures pour la même commande

Depuis Docker 1.13 (2017), les commandes qui agissent sur un objet (conteneur,
image, réseau, volume) s'écrivent aussi `docker OBJET VERBE`, qui dit sur quel
...
* ⚠️ Le raccourci cache parfois l'objet : `docker pull` télécharge une **image**,
donc la forme longue est `docker image pull`, pas `docker container pull`

* 🚫 Les commandes qui n'agissent sur aucun objet gardent leur forme unique :
`docker login`, `docker version`, `docker search`

* 📏 **Dans ce cours, on écrit toujours la forme de gestion.**
Vous rencontrerez les raccourcis partout ailleurs : sachez les lire.
...
image::anatomie-1.svg[]

[%auto-animate]
== 🩻 Anatomie

image::anatomie-2.svg[]

[%auto-animate]
== 🩻 Anatomie

image::anatomie-3.svg[]
[%auto-animate]
== 🩻 Anatomie

image::anatomie-4.svg[]

[%auto-animate]
== 🩻 Anatomie

image::anatomie-5.svg[]

[%auto-animate]
== 🩻 Anatomie

image::anatomie-6.svg[]

[%auto-animate]
== 🩻 Anatomie

image::anatomie-7.svg[]

[%auto-animate]
== 🩻 Anatomie

image::anatomie-8.svg[]
