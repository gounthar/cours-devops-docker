...
[%step]
* Récupérer un war sur Gitlab et le déployer dans un container `tomcat (https://github.com/gounthar/tp07-sample/releases/download/v2025.09.22-093157/sample-2025.09.22-093157.war)`
[%step]
...
[source,bash]
----
# Used to run a Docker container with the name "wildfly-container" using the "tomcat:11.0.11-jdk25-temurin-noble" image. The container is
...
# "/fully/qualified/path/on/my/computer/sample.war" file to "/opt/tomcat:11.0.11-jdk25-temurin-noble/standalone/deployments/sample.war"
...
# background.
docker run -d -p 8080:8080 -p 9990:9990 --name wildfly-container -v /fully/qualified/path/on/my/computer/sample.war:/opt/tomcat:11.0.11-jdk25-temurin-noble/standalone/deployments/sample.war tomcat:11.0.11-jdk25-temurin-noble
----
