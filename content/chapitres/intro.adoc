...
[.column]
--
image::type-1-hypervisor-examples.png["Logos d'hyperviseurs de type 1 : VMware vSphere, Microsoft Hyper-V, XenServer, KVM et Red Hat Virtualization"]
--
...
[.notes]
--
Source des deux images : https://www.ubackup.com/enterprise-backup/type-1-hypervisor-vs-type-2.html
--
