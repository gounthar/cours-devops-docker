...
[%step]
* Récupérer un war sur GitHub et le déployer dans un container `tomcat (https://github.com/gounthar/tp07-sample/releases/download/v2025.10.27-113330/sample-2025.10.27-113330.war)`
[%step]
