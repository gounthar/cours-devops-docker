...
=== Ubuntu 25.04 et le conflit Podman ⚠️

**Problème :** Ubuntu 25.04+ est livré avec Podman par défaut, ce qui peut empêcher Docker de fonctionner correctement.

**Symptôme :** Erreur "Cannot connect to the Docker daemon"
...
- Dans GitPod : aucun problème, Docker préconfiguré
