...
[source,bash]
----
docker container run --rm ghcr.io/sigstore/cosign/cosign:v2.6.1 verify \
...
[source,text]
----
Verification for ghcr.io/sigstore/cosign/cosign:v2.6.1 --
...
Avec une autre identité attendue, la commande échoue (code de sortie 12) : `no matching signatures`.

[.notes]
--
Sortie réelle, relevée le 2026-09-24 avec Docker 29.8.0.
