...
[%step]
* Récupérer un war sur Gitlab et le déployer dans un container `wildfly (https://github.com/gounthar/tp07-sample/releases/download/v2025.09.22-093157/sample-2025.09.22-093157.war)`
[%step]
