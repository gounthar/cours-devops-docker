...
[source,text]
----
Verification for ghcr.io/sigstore/cosign/cosign:v3.1.3 --
...
Avec une autre identité attendue, la commande échoue (code de sortie 1) : `no matching CertificateIdentity found`.
