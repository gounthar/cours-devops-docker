...
[source,bash]
----
docker image pull ubuntu:22.04   # Échec sur le réseau universitaire, ou succès temporaire avant d'être blacklistés
----
...
docker container run gradle      # Fonctionne de manière transparente
----
...
----
docker image pull ubuntu:22.04    # Utilise automatiquement le cache
docker container run python:3.9   # Fonctionne sans problème
----
...
[source,bash]
----
docker image build --build-arg https_proxy=http://cache-etu.univ-artois.fr:3128/ .
----
