...
GELF utilise UDP : le démon n'ouvre aucune connexion, il émet des datagrammes. Si personne n'écoute sur `localhost:12201`, rien ne le signale. Le conteneur sort en code 0 et Kibana reste vide.
